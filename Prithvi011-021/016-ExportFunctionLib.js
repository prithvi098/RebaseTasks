...
const addOperation = arithmeticExp(Number(arrayOperator[0]), arrayOperator[1], Number(arrayOperator[2]))
console.log("8 + 4 =>", addOperation);
const subOperation = arithmeticExp(addOperation, arrayOperator[3], (arrayOperator[4]))
